...
var LinkExternal = function (_a) {
    ...
    return (React__default['default'].createElement(Link, __assign({ external: true }, props),
        children,
        React__default['default'].createElement(Icon$R, { color: "success", ml: "4px" })));
};
    ...
    return (React__default['default'].createElement(StyledModal, null,
        React__default['default'].createElement(ModalHeader, null,
            ...
            !hideCloseButton && (React__default['default'].createElement(IconButton, { variant: "text", onClick: onDismiss, "aria-label": "Close the dialog" },
                React__default['default'].createElement(Icon$_, { color: "textSubtle" })))),
...
var Icon$9 = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        ...
        React__default['default'].createElement("path", { d: "M4.58055 17.5811C4.55417 17.6416 4.46055 17.6598 4.37526 17.6182C4.28838 17.5785 4.23959 17.496 4.26775 17.4352C4.29354 17.3729 4.38736 17.3555 4.47403 17.3973C4.56111 17.437 4.6107 17.5204 4.58055 17.5811Z" }),
        React__default['default'].createElement("path", { d: "M5.0654 18.1313C5.00828 18.1851 4.89661 18.1601 4.82084 18.075C4.74249 17.99 4.72781 17.8765 4.78573 17.8218C4.84464 17.7679 4.95294 17.7931 5.03148 17.8781C5.10983 17.964 5.1251 18.0768 5.0654 18.1313Z" }),
        React__default['default'].createElement("path", { d: "M5.53775 18.8332C5.46436 18.8851 5.34436 18.8364 5.27018 18.7281C5.19679 18.6198 5.19679 18.4899 5.27176 18.4378C5.34614 18.3858 5.46436 18.4326 5.53953 18.5401C5.61272 18.6502 5.61272 18.7802 5.53775 18.8332Z" }),
        React__default['default'].createElement("path", { d: "M6.18488 19.511C6.11923 19.5846 5.97939 19.5648 5.87705 19.4644C5.77232 19.3661 5.74316 19.2267 5.80901 19.1531C5.87546 19.0792 6.01609 19.1 6.11923 19.1997C6.22316 19.2977 6.2549 19.4381 6.18488 19.511Z" }),
        React__default['default'].createElement("path", { d: "M7.0772 19.9045C7.04824 19.9999 6.91356 20.0433 6.77789 20.0028C6.64242 19.961 6.55376 19.8492 6.58113 19.7528C6.6093 19.6568 6.74457 19.6116 6.88123 19.655C7.01651 19.6965 7.10537 19.8075 7.0772 19.9045Z" }),
        React__default['default'].createElement("path", { d: "M8.05768 19.9776C8.06105 20.0781 7.94601 20.1614 7.8036 20.1632C7.66039 20.1664 7.54456 20.0851 7.54297 19.9863C7.54297 19.8848 7.65543 19.8023 7.79864 19.7999C7.94105 19.7971 8.05768 19.8777 8.05768 19.9776Z" }),
        React__default['default'].createElement("path", { d: "M8.96967 19.8197C8.98673 19.9178 8.88775 20.0184 8.74633 20.0453C8.60729 20.0711 8.47856 20.0106 8.46091 19.9133C8.44365 19.8129 8.54441 19.7122 8.68326 19.6862C8.82488 19.6611 8.95162 19.7201 8.96967 19.8197Z" })));
};

var Icon$8 = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 18 10" }, props),
        React__default['default'].createElement("path", { d: "M5.07656 0C7.88062 0 10.1531 2.23881 10.1531 5.00034C10.1531 7.76188 7.87992 10 5.07656 10C2.2732 10 0 7.76119 0 5.00034C0 2.23949 2.2732 0 5.07656 0ZM13.1836 0.293005C14.5856 0.293005 15.7219 2.40044 15.7219 5.00034C15.7219 7.59956 14.5856 9.70768 13.1836 9.70768C11.7816 9.70768 10.6453 7.59956 10.6453 5.00034C10.6453 2.40113 11.7816 0.293005 13.1836 0.293005ZM17.107 0.78341C17.5999 0.78341 18 2.67144 18 5.00034C18 7.32856 17.6006 9.21728 17.107 9.21728C16.6134 9.21728 16.2148 7.32925 16.2148 5.00034C16.2148 2.67144 16.6141 0.78341 17.107 0.78341Z" })));
};
...
var Logo = function (_a) {
    ...
    return (React__default['default'].createElement(Flex, null,
        React__default['default'].createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "24px" }, isPushed ? (React__default['default'].createElement(Icon$y, { width: "24px", color: isDark ? "textSubtle" : "background" })) : (React__default['default'].createElement(Icon$z, { width: "24px", color: isDark ? "textSubtle" : "background" }))),
        isAbsoluteUrl ? (React__default['default'].createElement(StyledLink, { as: "a", to: href, "aria-label": "Aqua home page" }, innerLogo)) : (React__default['default'].createElement(StyledLink, { to: href, "aria-label": "Aqua home page" }, innerLogo))));
};
var templateObject_1$b;
...
var PanelFooter = function (_a) {
    ...
    return (React__default['default'].createElement(Container, null,
        ...
        React__default['default'].createElement(PriceEntry, null, wafiPriceUsd ? (React__default['default'].createElement(PriceLink, { href: wafiPriceLink, target: "_blank" },
            React__default['default'].createElement(Icon$P, { width: "32px", mr: "8px" }),
        ...
        React__default['default'].createElement(PriceEntry, null, ceaPriceUsd ? (React__default['default'].createElement(PriceLink, { href: ceaPriceLink, target: "_blank" },
            React__default['default'].createElement(Icon$O, { width: "32px", mr: "8px" }),
