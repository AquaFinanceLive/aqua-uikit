...
var Logo$1 = function (_a) {
    ...
    return (React__default['default'].createElement(Flex, null,
        React__default['default'].createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "24px" }, isPushed ? (React__default['default'].createElement(Icon$M, { width: "24px", color: isDark ? "textSubtle" : "background" })) : (React__default['default'].createElement(Icon$L, { width: "24px", color: isDark ? "textSubtle" : "background" }))),
...
var Avatar = function (_a) {
    ...
    var icon = image ? (React__default['default'].createElement("img", { src: image, alt: "profile avatar", height: "32px", width: "32px" })) : (React__default['default'].createElement(Icon$1j, { width: "32px", height: "32px" }));
    if (isExternal) {
