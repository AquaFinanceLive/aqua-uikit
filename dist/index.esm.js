...
var Icon$q = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 32 32" }, props),
        React.createElement("image", { width: "32", height: "32", href: "/images/cea.png" })));
};
...
var Icon$v = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 90 90" }, props),
        React.createElement("image", { width: 90, height: 90, href: "/images/wafi.png" })));
};

var Icon$w = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 90 90" }, props),
        React.createElement("image", { width: 90, height: 90, href: "/images/cea.png" })));
};
...
var ButtonMenuItem = function (_a) {
    ...
    if (!isActive) {
        return (React.createElement(InactiveButton, __assign({ forwardedAs: as, size: size, style: { borderRadius: "16px" }, variant: "tertiary", 
...
var LinkExternal = function (_a) {
    ...
    return (React.createElement(Link, __assign({ external: true }, props),
        children,
        React.createElement(Icon$t, { color: "success", ml: "4px" })));
};
...
var Logo = function (_a) {
    var props = __rest(_a, []);
    return (React.createElement(Svg, __assign({ viewBox: "0 0 81 38" }, props),
        React.createElement("image", { width: "81", height: "38", href: "/images/LogoText.png" })));
};
...
var Logo$1 = function (_a) {
    ...
    return (React.createElement(Flex, null,
        React.createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "24px" }, isPushed ? (React.createElement(Icon$N, { width: "24px", color: isDark ? "textSubtle" : "background" })) : (React.createElement(Icon$M, { width: "24px", color: isDark ? "textSubtle" : "background" }))),
        isAbsoluteUrl ? (React.createElement(StyledLink$1, { as: "a", href: href, "aria-label": "Aqua home page" }, innerLogo)) : (React.createElement(StyledLink$1, { to: href, "aria-label": "Aqua home page" }, innerLogo))));
};
...
var PanelBody = function (_a) {
    ...
    return (React.createElement(Container$3, null,
        ...
        React.createElement(Flex, { justifyContent: "center", mt: "16px" },
            React.createElement(CertifiedBadge, { href: "https://rugdoc.io/project/aqua-finance" },
                React.createElement("img", { src: "/images/rugdoc-review-badge.png", alt: "Rugdoc" })))));
};
...
var PanelFooter = function (_a) {
    ...
    return (React.createElement(Container$4, null,
        ...
        React.createElement(PriceEntry, null, wafiPriceUsd ? (React.createElement(PriceLink, { href: wafiPriceLink, target: "_blank" },
            React.createElement(Icon$v, { width: "32px", mr: "8px" }),
            React.createElement(Text, { color: "textSubtle", bold: true }, "$" + wafiPriceUsd.toFixed(5)))) : (React.createElement(Skeleton, { width: 80, height: 24 }))),
        React.createElement(PriceEntry, null, ceaPriceUsd ? (React.createElement(PriceLink, { href: ceaPriceLink, target: "_blank" },
            React.createElement(Icon$w, { width: "32px", mr: "8px" }),
            React.createElement(Text, { color: "textSubtle", bold: true }, "$" + ceaPriceUsd.toFixed(5)))) : (React.createElement(Skeleton, { width: 80, height: 24 }))),
        React.createElement(SettingsEntry, null,
            React.createElement(Button, { variant: "text", onClick: function () { return toggleTheme(!isDark); } },
                React.createElement(Flex, { alignItems: "center" },
                    React.createElement(SunIcon, { color: isDark ? "textDisabled" : "textSubtle", width: "24px" }),
                    React.createElement(Text, { color: "textDisabled", mx: "4px" }, "/"),
                    React.createElement(MoonIcon, { color: isDark ? "textSubtle" : "textDisabled", width: "24px" }))),
...
var WalletCard = function (_a) {
    ...
    return (React.createElement(Button, { fullWidth: true, variant: "tertiary", onClick: function () {
        ...
        React.createElement(Text, { bold: true, color: "textSubtle", mr: "16px" }, title),
...
var AccountModal = function (_a) {
    ...
    return (React.createElement(Modal, { title: "Your wallet", onDismiss: onDismiss },
        ...
        React.createElement(Flex, { mb: "32px" },
            React.createElement(LinkExternal, { color: "success", small: true, href: "https://bscscan.com/address/" + account, mr: "16px" }, "View on BscScan"),
