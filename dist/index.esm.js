...
var Logo$1 = function (_a) {
    ...
    return (React.createElement(Flex, null,
        React.createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "24px" }, isPushed ? (React.createElement(Icon$M, { width: "24px", color: isDark ? "textSubtle" : "background" })) : (React.createElement(Icon$L, { width: "24px", color: isDark ? "textSubtle" : "background" }))),
